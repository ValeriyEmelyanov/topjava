...
### Добавил валидацию при сохранении в JDBC через Bean Validation API
#### Apply 10_06_jdbc_validation.patch
- [Валидация данных при помощи Bean Validation API](https://alexkosarev.name/2018/07/30/bean-validation-api/). Т.к. `Validator` thread-safe (из Javadoc), его можно создать один раз и переиспользовать 
- Рефакторинг тестов: удалил `AbstractJpaUserServiceTest`
...
#### Apply 10_07_secure_tag_annotation.patch
...
#### Apply 10_10_registration.patch
...
#### Apply 10_11_not_found_422.patch
...
#### Apply 10_12_global_exception.patch
...
#### Apply 10_13_controller_advice_exception.patch
...
#### Apply 10_14_password_encoding.patch
...
#### Apply 10_15_read_write_access.patch
