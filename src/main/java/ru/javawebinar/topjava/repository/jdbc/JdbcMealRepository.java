...
public abstract class JdbcMealRepository<T> implements MealRepository {
    ...
    public static class Java8JdbcMealRepisitory extends JdbcMealRepository<LocalDateTime> {
        public Java8JdbcMealRepisitory(JdbcTemplate jdbcTemplate, NamedParameterJdbcTemplate namedParameterJdbcTemplate) {
